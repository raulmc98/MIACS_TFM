...
New-GPLink -Name "DisableUAC" -Target "ou=IT Computers,ou=IT,dc=miacsdomain,dc=com"

#add the security filtering, uncomment if not needed
Set-GPPermission -Name "DisableUAC" -TargetName "Win-10" -TargetType Computer -PermissionLevel GPOApply