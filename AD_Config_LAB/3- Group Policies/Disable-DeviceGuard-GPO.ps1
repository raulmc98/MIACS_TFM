...
New-GPLink -Name "DisableDeviceGuard" -Target "ou=IT Computers,ou=IT,dc=miacsdomain,dc=com"

#security filtering, if you want to apply it to only certain machines.
Set-GPPermission -Name "DisableDeviceGuard" -TargetName "Win-10" -TargetType Computer -PermissionLevel GPOApply
