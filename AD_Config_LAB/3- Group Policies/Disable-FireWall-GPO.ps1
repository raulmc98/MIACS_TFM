...
New-GPLink -Name "DisableFW" -Target "ou=IT Computers,ou=IT,dc=miacsdomain,dc=com"

#security filtering, if you want to apply it to only certain machines.
Set-GPPermission -Name "DisableFW" -TargetName "Win-10" -TargetType Computer -PermissionLevel GPOApply