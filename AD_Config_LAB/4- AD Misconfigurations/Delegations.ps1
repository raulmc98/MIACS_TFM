...
Set-ADObject -Identity "CN=web.srvc,OU=Service accounts,DC=miacsdomain,DC=com" -Add @{'msDS-AllowedToDelegateTo'=@('HOST/DC-01/miacsdomain','HOST/DC-01.miacsdomain.com/miacsdomain')}
Set-ADAccountControl -Identity "CN=web.srvc,OU=Service accounts,DC=miacsdomain,DC=com" -TrustedForDelegation $false -TrustedToAuthForDelegation $true